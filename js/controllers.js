angular.module('SvgMapApp', ['ngMaterial'])
    .controller('MainCtrl', ['$scope', function ($scope) {
        ...
        $scope.calcValues = function(){
          $scope.dummyData = $scope.dataSets[$scope.settings.year];
          var electoralVoteValue = $scope.calcElectoralVoteValue();
          $scope.totals= {population:0,
                          ...
                          repElectoralVotes:0,
                          electoralVotes:0,
                          electoralVoteValue:electoralVoteValue
                        };
          ...
          for (var abr in $scope.dummyData) {
              ...
              if ($scope.settings.ElectoralStateDistribution != 'weighted') {
                electoralVotes = Math.round(state.population / $scope.totals.electoralVoteValue);
              } else {
                electoralVotes = state.electoralVotes;
              }

              state.value = state.repVotes/
                           (state.demVotes+
                            state.repVotes);

              if ($scope.settings.ElectoralVoteDistribution == 'winner-take-all' &&
                  $scope.settings.voteDisplay=='electoral') {
              ...
              if ($scope.settings.ElectoralVoteDistribution == 'winner-take-all') {
                ...
                if (state.demVotes >= state.repVotes) {
                ...
                state.repElectoralVotes = Math.round(electoralVotes*state.value);
                state.demElectoralVotes = Math.round(electoralVotes*(1-state.value));
            ...
            $scope.totals.electoralVoteValue = Math.round($scope.totals.population/538);
